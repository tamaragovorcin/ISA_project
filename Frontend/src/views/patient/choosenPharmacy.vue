...
<template>
  ...
  <p class="tab"></p>      
        ...
        <div style="background: lightgray; height: 60px;">
            ...
            <span style="float: left; margin: 15px;">
                <strong><button class = "btn btn-link btn" style=" color:black; float:left; margin-left:20px; margin-top:0px;" v-on:click = "allPharmacies">Show all pharmacies</button></strong>
                     <p class="tab"></p>                  
