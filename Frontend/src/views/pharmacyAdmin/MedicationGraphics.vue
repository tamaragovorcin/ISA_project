...
<a   class = "btn btn-link" href="/updatePharmacyProfile">Update pharmacy</a>
  ...
  <section class="container">
    <div class="columns">
      ...
      <div class="column">
    <h3 style="color: #0D184F">Yearly review of medication consumption</h3>

   <chartjs-line :labels="labels" :data="dataset" :bind="true"></chartjs-line>
       <h3 style="color: #0D184F">Monthly review of medication consumption</h3>

   <chartjs-line :labels="labels1" :data="dataset1" :bind="true"></chartjs-line>
       <h3 style="color: #0D184F">Quarterly review of medication consumption</h3>
...
<script>
  ...
  addData () {
   ...
   mounted() {
        ...
        this.axios.get('/graphical/medicationYearly',{ 
                         headers: {
                                'Authorization': 'Bearer ' + token,
          }}).then(response => {
        ...
        this.axios.get('/graphical/medicationMonthly',{ 
                         headers: {
                                'Authorization': 'Bearer ' + token,
                }}).then(response => {
         ...
         this.axios.get('/graphical/medicationQuarter',{ 
                         headers: {
                                'Authorization': 'Bearer ' + token,
                }}).then(response => {
