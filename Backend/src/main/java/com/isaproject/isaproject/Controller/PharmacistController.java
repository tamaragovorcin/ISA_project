...
public class PharmacistController {
    ...
    public ResponseEntity<String> leaveAMark(@RequestBody MarkDTO dto) {
        ...
        String response = "";
        Boolean able = ableToRatePharmacist(dto.getPharmacist().getId(), dto.getPatient());
        ...
        if (able) {
            ...
            for (MarkPharmacist mark1 : markList) {
                if (mark1.getPharmacist().getId() == dto.getPharmacist().getId() && mark1.getPatient().getId() == dto.getPatient()) {
                    hasPharmacist = false;

                    if (mark1.getPatient().getId() != dto.getPatient() && mark1.getPharmacist().getId() == dto.getPharmacist().getId()) {
                        hasPatient = true;
                    }
                }
            }
            ...
            for (MarkPharmacist mark1 : markList) {
                ...
                } else if(mark1.getPatient().getId() != dto.getPatient() && mark1.getPharmacist().getId() == dto.getPharmacist().getId() && hasPatient) {
