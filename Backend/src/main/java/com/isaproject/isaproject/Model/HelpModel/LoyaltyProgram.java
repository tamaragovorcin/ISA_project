...
public class LoyaltyProgram {
    ...
    public LoyaltyProgram(Integer id, double consultingPoints, double examinationPoints, double regularLimit, double silverLimit, double goldLimit, double regularDiscount, double silverDiscount, double goldenDiscount) {
        this.id = id;
